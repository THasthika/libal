...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(nobase_include_HEADERS) $(top_srcdir)/build-aux/test-driver \
...
am_libTHB_la_OBJECTS = THB/list.lo THB/queue.lo THB/stack.lo \
	THB/hash_table.lo THB/merge_sort.lo THB/insertion_sort.lo \
	THB/heap_sort.lo
libTHB_la_OBJECTS = $(am_libTHB_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
am_check_hash_table_OBJECTS = tests/check_hash_table.$(OBJEXT)
check_hash_table_OBJECTS = $(am_check_hash_table_OBJECTS)
check_hash_table_DEPENDENCIES = libTHB.la
...
# cp_CFLAGS = -g3 --std=c99 -DNDEBUG
lib_LTLIBRARIES = libTHB.la
libTHB_la_SOURCES = THB/list.c THB/list.h THB/queue.c THB/queue.h THB/stack.c THB/stack.h THB/hash_table.c THB/hash_table.h THB/sort.h THB/merge_sort.c THB/insertion_sort.c THB/heap_sort.c
...
THB/$(am__dirstamp):
	@$(MKDIR_P) THB
	@: > THB/$(am__dirstamp)
THB/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) THB/$(DEPDIR)
	@: > THB/$(DEPDIR)/$(am__dirstamp)
THB/list.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)
THB/queue.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)
THB/stack.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)
THB/hash_table.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)
THB/merge_sort.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)
THB/insertion_sort.lo: THB/$(am__dirstamp) \
	THB/$(DEPDIR)/$(am__dirstamp)
THB/heap_sort.lo: THB/$(am__dirstamp) THB/$(DEPDIR)/$(am__dirstamp)

libTHB.la: $(libTHB_la_OBJECTS) $(libTHB_la_DEPENDENCIES) $(EXTRA_libTHB_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK) -rpath $(libdir) $(libTHB_la_OBJECTS) $(libTHB_la_LIBADD) $(LIBS)
...
tests/$(DEPDIR)/$(am__dirstamp):
	...
	@: > tests/$(DEPDIR)/$(am__dirstamp)
tests/check_hash_table.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)

check_hash_table$(EXEEXT): $(check_hash_table_OBJECTS) $(check_hash_table_DEPENDENCIES) $(EXTRA_check_hash_table_DEPENDENCIES) 
	@rm -f check_hash_table$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(check_hash_table_OBJECTS) $(check_hash_table_LDADD) $(LIBS)
tests/check_list.$(OBJEXT): tests/$(am__dirstamp) \
	tests/$(DEPDIR)/$(am__dirstamp)
...
include THB/$(DEPDIR)/hash_table.Plo
include THB/$(DEPDIR)/heap_sort.Plo
include THB/$(DEPDIR)/insertion_sort.Plo
include THB/$(DEPDIR)/list.Plo
include THB/$(DEPDIR)/merge_sort.Plo
include THB/$(DEPDIR)/queue.Plo
...
recheck: all $(check_PROGRAMS)
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
check_list.log: check_list$(EXEEXT)
	@p='check_list$(EXEEXT)'; \
	b='check_list'; \
...
check_stack.log: check_stack$(EXEEXT)
	...
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
	"$$tst" $(AM_TESTS_FD_REDIRECT)
check_hash_table.log: check_hash_table$(EXEEXT)
	@p='check_hash_table$(EXEEXT)'; \
	b='check_hash_table'; \
	$(am__check_pre) $(LOG_DRIVER) --test-name "$$f" \
	--log-file $$b.log --trs-file $$b.trs \
	$(am__common_driver_flags) $(AM_LOG_DRIVER_FLAGS) $(LOG_DRIVER_FLAGS) -- $(LOG_COMPILE) \
...
distclean-generic:
	...
	-rm -f THB/$(DEPDIR)/$(am__dirstamp)
	-rm -f THB/$(am__dirstamp)
